...
import 'package:passwordsecurity/data/settings_repository.dart';
...
class _IntroScreenState extends State<IntroScreen> {
  final List<Map<String, String>> _pages = [
    {
      'title': 'Bem vindo ao Password Security',
      'subtitle': 'Aprenda a usar o app passo a passo',
      'lottie': 'assets/lottie/Lock.json',
    },
    {
      'title': 'Funcionalidades',
      'subtitle': 'Guarde suas senhas em um lugar dinâmico e seguro!',
